 ...
 * 根据用户名查询自己的送礼物明细
 */
@WebServlet("/live/getGivingGiftStatements")
public class GivingGiftStatementsServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<GiftStatementsBean> list = dao.getGivingGiftStatementsByPage(pageId,pageSize,uname);
		Result result = new Result();
		if(list==null){
			result.setRetMsg(false);
			result.setRetCode(I.MSG_GET_GIVING_GIFT_STATEMENTS_FAIL);
		}else{
