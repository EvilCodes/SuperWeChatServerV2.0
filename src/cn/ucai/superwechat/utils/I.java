...
//	String AVATAR_PATH 								= 		"E:/test/";
	...
	String AVATAR_TYPE_CHATROOM_PATH 				=		"chatroom_icon";					//聊天室头像保存目录
	...
	// 直播相关
	int MSG_GET_GIFTS_FAIL							=		1001;							//获取所有礼物失败
	int MSG_GET_RECHARGESTATEMENTS_FAIL				=		1002;							//获取充值记录失败
	int MSG_GET_BALANCE_FAIL			        	=		1003;							//获取余额失败
	int MSG_GET_GIFT_STATEMENTS_BY_ANCHOR_FAIL     	=		1004;							//统计主播收到礼物信息失败
	int MSG_GIVING_GIFTS_FAIL						=		1005;							//赠送礼物失败
	int MSG_NOT_SUFFICIENT_FOUND                	=		1006;							//送礼物余额不足
	int MSG_RECHARGE_FAIL                       	=		1007;							//充值失败
	int MSG_GET_GIVING_GIFT_STATEMENTS_FAIL       	=		1008;							//获取送礼流水失败
	int MSG_GET_RECEIVING_GIFT_STATEMENTS_FAIL  	=		1009;							//获取收礼流水失败
	int MSG_REGISTER_UPLOAD_CHATROOM_AVATAR_FAIL  	=		1010;							//上传聊天室头像失败
	...
	/** 聊天室申请token */
	String REQUEST_URL_GET_TOKEN = "https://a1.easemob.com/i/superwechat201610/token";
	/** 创建聊天室 */
	String REQUEST_BASE_URL_CHATROOM = "https://a1.easemob.com/i/superwechat201610/chatrooms";
}
